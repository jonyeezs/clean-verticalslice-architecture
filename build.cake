...
string projectTag = "DotNetArchitecture";
string rootNamespace = "CleanSlice";
...
Task("Clean")
    .Does(() => {
    DotNetClean("./DotNetArchitecture.sln");
});
...
Task("Build")
    ...
    .Does(() => {
     var buildSettings = new DotNetBuildSettings {
                        ...
                        ArgumentCustomization = args => args.Append("-p:UseSharedCompilation=false")
                       };
     var projects = GetFiles("./**/**/*.csproj");
     foreach(var project in projects )
     {
